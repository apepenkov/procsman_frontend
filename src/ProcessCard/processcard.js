                ...
                <Modal.Body>
                    ...
                    >
                        <Tab eventKey={'status'} title='Status, resources, events'>
                            <ProcessCardStats process={process} showDetails={showDetails}
                                              selectedTab={selectedTab}></ProcessCardStats>

                        </Tab>
                        <Tab title={'Logs'} eventKey={'logs'}>
                            <ProcessCardLogs process={process} showDetails={showDetails}
                                              selectedTab={selectedTab}></ProcessCardLogs>
                        </Tab>
                        <Tabs title={'Configuration'} eventKey={'configuration'}>
                            <ProcessCardEdit process={process} showDetails={showDetails}
                                                selectedTab={selectedTab} setShowDetails={setShowDetails}></ProcessCardEdit>
                        </Tabs>
                    </Tabs>
                </Modal.Body>
                <Modal.Footer>
